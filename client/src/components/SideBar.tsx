          ...
          <div className="h-full bg-white dark:bg-gray-700">
            ...
            <nav className="mt-6">
              <div>
                <Link
                  href="/dashboard"
                  className="flex items-center justify-start w-full p-2 pl-6 my-2 text-gray-800 transition-colors duration-200 border-l-4 border-primary-700 dark:text-white"
                >
                ...
                >
                  ...
                  <span className="mx-4 text-sm font-normal">Ajuda</span>
                </Link>
              </div>
            </nav>
          </div>
